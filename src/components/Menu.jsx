      ...
      >
        <div className="flex-1 flex items-start justify-center flex-col gap-6 p-8">
          ...
          <MenuButton label="Contact" onClick={() => onSectionChange(3)} />
            <a className="text-2xl font-bold cursor-pointer hover:text-indigo-600 transition-colors" href="https://github.com/Anandakrishnan66">Github</a>
          <MenuButton label="Certifications" onClick={()=>onSectionChange(5)}/>
